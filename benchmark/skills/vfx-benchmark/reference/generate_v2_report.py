...
Usage:
    python benchmark/skills/vfx-benchmark/reference/generate_v2_report.py [--input /tmp/v2_report_data.json] [--output REPORT.html]
"""
import argparse
import base64
import json
...
<body>
  ...
  <footer style="margin-top:40px;padding-top:20px;border-top:1px solid var(--border);color:var(--muted);font-size:12px;">
    Generated by <code>benchmark/skills/vfx-benchmark/reference/generate_v2_report.py</code>.
