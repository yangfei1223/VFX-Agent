...
def render_sample_card(sample: dict) -> str:
    ...
    <div class="sample-card" id="sample-{escape(name)}">
      ...
      <div class="sample-scores">
        ...
        <div class="score-block">
          <div class="score-label">v2.0 codex OD</div>
...
<head>
<meta charset="UTF-8">
<title>VFX-Agent v2.0 codex OD — 测试报告</title>
<style>
  :root {{
    --bg: #0f172a;
    --panel: #1e293b;
...
<body>
  <div class="header">
    <h1>VFX-Agent v2.0 codex OD — 全样本测试报告</h1>
    <div class="subtitle">Dynamic orchestration via codex + isolated subagent evaluator</div>
    <div class="meta">
  ...
  <section>
    ...
    {''.join(render_sample_card(s) for s in samples)}
  </section>
  ...
  <footer style="margin-top:40px;padding-top:20px;border-top:1px solid var(--border);color:var(--muted);font-size:12px;">
    ...
    v2.0 architecture: codex OD mode with 6-phase workflow + isolated subagent evaluator.
  </footer>
</body>
</html>
"""
