# Shader Skill Reference

> Complete catalog of GLSL operators for visual effect composition.
> Auto-injected by context_assembler.py for Generate Agent as knowledge layer.
>
> All 2D SDF formulations based on Inigo Quilez's canonical definitions:
